#!/usr/bin/env bash
# Taxol benzamide / 6-31g — NTO-bath augmentation with CANONICAL cluster solver.
...
LOG=/tmp/taxol_steom_631g_diag_canon.log
echo ">>> DMET-STEOM Taxol benzamide / 6-31g / NTO-bath / CANONICAL solver  -> $LOG"
$GANSU -x $XYZ -g 6-31g \
