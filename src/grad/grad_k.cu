...
// CPU host-callable mirror of compute_gradients_kinetic.  See grad_s.cu
// for the launching pattern.
void compute_gradients_kinetic_cpu(double* g_gradients, const real_t* g_density_matrix,
